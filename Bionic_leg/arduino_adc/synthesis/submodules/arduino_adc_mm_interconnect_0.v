// arduino_adc_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module arduino_adc_mm_interconnect_0 (
		...
		input  wire [21:0] nios2_qsys_data_master_address,               //                 nios2_qsys_data_master.address
		...
		input  wire [21:0] nios2_qsys_instruction_master_address,        //          nios2_qsys_instruction_master.address
	...
	wire  [21:0] nios2_qsys_data_master_translator_avalon_universal_master_0_address;              // nios2_qsys_data_master_translator:uav_address -> nios2_qsys_data_master_agent:av_address
	...
	wire  [21:0] nios2_qsys_instruction_master_translator_avalon_universal_master_0_address;       // nios2_qsys_instruction_master_translator:uav_address -> nios2_qsys_instruction_master_agent:av_address
	...
	wire  [21:0] sysid_qsys_control_slave_agent_m0_address;                                        // sysid_qsys_control_slave_agent:m0_address -> sysid_qsys_control_slave_translator:uav_address
	...
	wire  [97:0] cmd_mux_src_data;                                                                 // cmd_mux:src_data -> sysid_qsys_control_slave_agent:cp_data
	...
	wire  [21:0] nios2_qsys_debug_mem_slave_agent_m0_address;                                      // nios2_qsys_debug_mem_slave_agent:m0_address -> nios2_qsys_debug_mem_slave_translator:uav_address
	...
	wire  [97:0] cmd_mux_001_src_data;                                                             // cmd_mux_001:src_data -> nios2_qsys_debug_mem_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                            // nios2_qsys_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [5:0] cmd_mux_001_src_channel;                                                          // cmd_mux_001:src_channel -> nios2_qsys_debug_mem_slave_agent:cp_channel
	...
	wire  [21:0] motor_s1_agent_m0_address;                                                        // Motor_s1_agent:m0_address -> Motor_s1_translator:uav_address
	...
	wire  [98:0] motor_s1_agent_rf_source_data;                                                    // Motor_s1_agent:rf_source_data -> Motor_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] motor_s1_agent_rsp_fifo_out_data;                                                 // Motor_s1_agent_rsp_fifo:out_data -> Motor_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                            // cmd_mux_003:src_valid -> Motor_s1_agent:cp_valid
	wire  [97:0] cmd_mux_003_src_data;                                                             // cmd_mux_003:src_data -> Motor_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                            // Motor_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                          // cmd_mux_003:src_channel -> Motor_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                    // cmd_mux_003:src_startofpacket -> Motor_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                      // cmd_mux_003:src_endofpacket -> Motor_s1_agent:cp_endofpacket
	...
	wire  [97:0] cmd_mux_004_src_data;                                                             // cmd_mux_004:src_data -> uart_0_s1_agent:cp_data
	...
	wire  [21:0] adc_ltc2308_slave_agent_m0_address;                                               // adc_ltc2308_slave_agent:m0_address -> adc_ltc2308_slave_translator:uav_address
	...
	wire  [97:0] cmd_mux_005_src_data;                                                             // cmd_mux_005:src_data -> adc_ltc2308_slave_agent:cp_data
	...
	wire  [97:0] sysid_qsys_control_slave_agent_rp_data;                                           // sysid_qsys_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [97:0] nios2_qsys_debug_mem_slave_agent_rp_data;                                         // nios2_qsys_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire         motor_s1_agent_rp_valid;                                                          // Motor_s1_agent:rp_valid -> router_005:sink_valid
	wire  [97:0] motor_s1_agent_rp_data;                                                           // Motor_s1_agent:rp_data -> router_005:sink_data
	wire         motor_s1_agent_rp_ready;                                                          // router_005:sink_ready -> Motor_s1_agent:rp_ready
	wire         motor_s1_agent_rp_startofpacket;                                                  // Motor_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         motor_s1_agent_rp_endofpacket;                                                    // Motor_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [97:0] uart_0_s1_agent_rp_data;                                                          // uart_0_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [97:0] adc_ltc2308_slave_agent_rp_data;                                                  // adc_ltc2308_slave_agent:rp_data -> router_007:sink_data
	...
	wire         motor_s1_agent_rdata_fifo_src_valid;                                              // Motor_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] motor_s1_agent_rdata_fifo_src_data;                                               // Motor_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         motor_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_003:in_0_ready -> Motor_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                // avalon_st_adapter_003:out_0_valid -> Motor_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                 // avalon_st_adapter_003:out_0_data -> Motor_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                // Motor_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                // avalon_st_adapter_003:out_0_error -> Motor_s1_agent:rdata_fifo_sink_error
	...
	arduino_adc_mm_interconnect_0_router router (
	...
	arduino_adc_mm_interconnect_0_router_001 router_001 (
	...
	arduino_adc_mm_interconnect_0_router_002 router_002 (
	...
	arduino_adc_mm_interconnect_0_router_003 router_003 (
	...
	arduino_adc_mm_interconnect_0_router_003 router_004 (
	...
	arduino_adc_mm_interconnect_0_router_002 router_005 (
	...
	arduino_adc_mm_interconnect_0_router_002 router_006 (
	...
	arduino_adc_mm_interconnect_0_router_002 router_007 (
	...
	arduino_adc_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_50_clk_clk),                                       //        clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	arduino_adc_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_50_clk_clk),                                              //        clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	arduino_adc_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_50_clk_clk),                               //       clk.clk
		.reset               (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arduino_adc_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_50_clk_clk),                               //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arduino_adc_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_50_clk_clk),                               //       clk.clk
		.reset               (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arduino_adc_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_50_clk_clk),                               //       clk.clk
		.reset               (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arduino_adc_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_50_clk_clk),                               //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arduino_adc_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_50_clk_clk),                               //       clk.clk
		.reset               (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arduino_adc_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_50_clk_clk),                               //       clk.clk
		.reset              (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arduino_adc_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_50_clk_clk),                               //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arduino_adc_mm_interconnect_0_rsp_demux_001 rsp_demux_002 (
		.clk                (clk_50_clk_clk),                               //       clk.clk
		.reset              (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arduino_adc_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_50_clk_clk),                               //       clk.clk
		.reset              (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arduino_adc_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_50_clk_clk),                               //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arduino_adc_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_50_clk_clk),                               //       clk.clk
		.reset              (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arduino_adc_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_50_clk_clk),                               //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arduino_adc_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_50_clk_clk),                               //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arduino_adc_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
